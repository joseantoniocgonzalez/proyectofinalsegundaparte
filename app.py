...
def eventos():
    ...
    #Sacamos el artista  del formulario del index.html
    palabra_clave=request.form.get("artista")
    #Selecionamos el país  del formulario
    ...
    if r.status_code == 200:
        ...
        #Si el método por el que se accede es un POST cogemos la información dependiendo de los parametros indicados por el usuario.
            ...
            if "_embedded" not in contenido:
                ...
                fecha_str=[]
                identificadores=[]
                #nos muestra y guarda  el número de coincidencias
                coincidencias=0
                pais=request.form.get("pais")
                #lo Guardarmos contenido en listas
